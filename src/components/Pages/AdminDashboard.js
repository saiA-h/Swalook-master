                      ...
                      <tr key={row.id}>
                        ...
                        <td className="action-cell">
                          ...
                          <Tooltip title="Share via WhatsApp" arrow>
                            <img 
                              src="https://static.vecteezy.com/system/resources/previews/018/819/288/original/whatsapp-icon-transparent-free-png.png" 
                              alt="WhatsApp" 
                              style={{ width: "24px", height: "24px", cursor: "pointer" }} 
                              onClick={() => {/* Add your share functionality here */}} 
                            />
                          </Tooltip>
